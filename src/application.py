...
class Application:
    ...
    def __init__(self, width: int = 1250, height: int = 500):
        ...
        self._files_widget = FilesRow(progress_bar=self._progress, master=self._window)
    ...
    def _create_widgets(self):
        ...
        # second column of the row 1 - cipher mode
        self._mode_chooser = ModeChooser(master=settings_frame)
    ...
    def _generate_key(self):
        ...
        self._files_widget.local_file.add_keys(self._key.key, self._init_vector.key)
